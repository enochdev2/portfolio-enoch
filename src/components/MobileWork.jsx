...
const ProjectCard = ({
  ...
  return (
    // <motion.div variants={slideIn("up", "tween", index * 0.2, 1)} className="my-5">
    <Tilt
      options={{
        max: 45,
        scale: 1,
      ...
      <div className="relative w-full h-[230px]">
        ...
        <div className="absolute inset-0 flex justify-between m-3 card-img_hover">
          <div
            ...
            className="black-gradient border border-cyan-900 w-15 h-10 rounded-lg flex justify-center items-center cursor-pointer"
          >
            <img
              src={livedemo}
              alt="source code"
...
export default SectionWrapper(MobileWorks, "MobileWorks");
